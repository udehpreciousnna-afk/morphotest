...
const app = express();
// Gzip/Brotli-style compression for all responses (HTML/JSON/JS/CSS) — cuts payload size drastically.
app.use(compression());
...
// ---- Static SPA ---------------------------------------------------
// Cache hashed/static assets (images, etc.) aggressively; keep index.html short-cached
// so users always get fresh app code without re-downloading unchanged assets every visit.
